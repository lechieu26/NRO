package com.twinkle.models.map.blackball;
...
public class BlackBallWar {
    ...
    public static final byte HOUR_OPEN = 20;// giờ vào nrsd
    public static final byte MIN_OPEN = 0;//phút vào
    public static final byte SECOND_OPEN = 0;//giây tối đa 59

    public static final byte HOUR_CAN_PICK_DB = 20; //phút được lụm
    public static final byte MIN_CAN_PICK_DB = 30;//phút hết đc lụm
    public static final byte SECOND_CAN_PICK_DB = 0;

    public static final byte HOUR_CLOSE = 21;//số giờ đóng nrd dưới là phút
