...
import com.twinkle.models.boss.dhvt.BossDHVT;
...
public class Zone {
    ...
    public int getCountItemAppeaerd() {
        return countItemAppeaerd;
    }

    public void setCountItemAppeaerd(int countItemAppeaerd) {
        this.countItemAppeaerd = countItemAppeaerd;
    }
    ...
    public long getLastTimeDropBlackBall() {
        return lastTimeDropBlackBall;
    }

    public void setLastTimeDropBlackBall(long lastTimeDropBlackBall) {
        this.lastTimeDropBlackBall = lastTimeDropBlackBall;
    }

    public boolean isFinishBlackBallWar() {
        return finishBlackBallWar;
    }

    public void setFinishBlackBallWar(boolean finishBlackBallWar) {
        this.finishBlackBallWar = finishBlackBallWar;
    }

    public boolean isFinishMapMaBu() {
        return finishMapMaBu;
    }

    public void setFinishMapMaBu(boolean finishMapMaBu) {
        this.finishMapMaBu = finishMapMaBu;
    }

    public List<TrapMap> getTrapMaps() {
        return trapMaps;
    }

    public void setTrapMaps(List<TrapMap> trapMaps) {
        this.trapMaps = trapMaps;
    }
