...
import com.twinkle.models.skill.PlayerSkill;

import java.util.List;
//import com.twinkle.Manager.ArchivementManager;
import com.twinkle.models.clan.Clan;
import com.twinkle.models.intrinsic.IntrinsicPlayer;
...
import com.twinkle.models.mob.MobMe;
...
import com.twinkle.models.map.vodaibahatmit.FightBossBahatmit;
import com.twinkle.models.matches.IPVP;
...
import com.twinkle.models.task.TaskPlayer;
...
import com.twinkle.services.func.CombineNew;
...
//    private Archivement archivement;
    ...
    public Player() {
        ...
        fightMabu = new FightMabu(this);
         fightbahatmit = new FightBossBahatmit(this);
        //----------------------------------------------------------------------
        iDMark = new IDMark();
...
//        this.archivement = new Archivement();
//        this.archivement.setList(ArchivementManager.getInstance().list);
    }
                        ...
                        if (it != null && it.isNotNullItem() && this.newpet == null && this.newpet1 == null) {
                            switch (it.template.id) {
                                ...
                                case 1212: //Gà 9 cựa
                                    ...
                                    Service.gI().point(this);
                                    break;
                                case 1213: //Ngựa 9 hông mao
                                    PetService.Pet2(this, 1228, 1229, 1230);
                                    Service.gI().point(this);
                                    break;
                                case 1039: //người bí ngô
                                    PetService.Pet2(this, 1258,	1259,	1260);
                                    newpet.name="Người Bí Ngô";
                                    Service.gI().point(this);
                                    break;
                            }
                        }
    ...
    private static final short[][] idOutfitFusion = {
            ...
            {1207,1208,1209},{2039,2040,2041},{1204,1205,1206},//bt4
    };
                ...
                switch (plAtt.playerSkill.skillSelect.template.id) {
                    ...
                    case Skill.ANTOMIC:
                        if (this.nPoint.voHieuChuong > 0) {
                            com.twinkle.services.PlayerService.gI().hoiPhuc(this, 0, damage * this.nPoint.voHieuChuong / 100);
                            return 0;
                        }
                }
            }
