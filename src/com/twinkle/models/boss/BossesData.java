...
//            TypeAppear.ANOTHER_LEVEL
    ...
    public static final BossData TRUNG_UY_TRANG = new BossData(
            ...
            1000, //dame
            new int[]{Util.nextInt(1_000_000,20_000_000)}, //hp
            new int[]{62}, //map join
    ...
    public static final BossData COOLER_GOLD = new BossData(
            ...
            new int[]{6,5,13,20}, //map join
            new int[][]{
                    {Skill.THOI_MIEN, 7, 10000000},
                    {Skill.DICH_CHUYEN_TUC_THOI, 7, 300000},
                    {Skill.KAMEJOKO, 7, 10000},
                    {Skill.LIEN_HOAN, 7, 1000},
                    {Skill.TAI_TAO_NANG_LUONG, 7, 50000000},
    ...
    public static final BossData CUMBER = new BossData(
            ...
            new int[][]{
                    ...
                    {Skill.ANTOMIC, 7, 1000},
                    {Skill.TAI_TAO_NANG_LUONG, 7, 10000000},
                    {Skill.BIEN_KHI, 7, 1000000}}, //skill
...
//            new int[]{14}, //map join
    ...
    public static final BossData MABU = new BossData(
            ...
            10000,
            new int[]{120000000},
            new int[]{0 ,7 ,14 ,5,6,29,30,28,27,18,19,20,37,38,36,13,33,34,32},
            new int[][]{
    ...
    public static final BossData MABU1 = new BossData(
            "Mabư",
            ConstPlayer.XAYDA,
            new short[]{297, 298, 299, -1, -1, -1},
            1000,
    ...
    public static final BossData MABU2 = new BossData(
            "Mabư",
            ConstPlayer.XAYDA,
            new short[]{297, 298, 299, -1, -1, -1},
            1000,
...
//                 {Skill.SOCOLA, 7, 6000},
 ...
 //                 {Skill.DE_TRUNG, 7, 6000},
                     {Skill.SUPER_KAME, 7, 6000},
                    {Skill.TAI_TAO_NANG_LUONG, 7, 600000},
                    {Skill.LIEN_HOAN, 7, 100},
                    {Skill.KAMEJOKO, 7, 1000}}, //skill
            new String[]{
                    "|-1|Tuy không biết các ngươi là ai, nhưng ta rất ấn tượng đấy!",
    ...
    public static final BossData THIEN_SU_WHIS = new BossData(
            ...
            new int[][]{
                    {Skill.KHIEN_NANG_LUONG, 7, 1000000},
                   {Skill.DICH_CHUYEN_TUC_THOI, 7, 500000},},//skill
    ...
    public static final BossData THIEN_SU_VADOS = new BossData(
            ...
            new int[][]{
                    {Skill.KHIEN_NANG_LUONG, 7, 1000000},
                    {Skill.DICH_CHUYEN_TUC_THOI, 7, 5000000},},//skill
            new String[]{"|-2|Kia là ai thế",
                    "|-1|Ta là Vados",
 ...
 public static final BossData SUPER_ANDROID_17 = new BossData(
            "KAMI", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{566, 567, 568, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            5500, //dame
            new int[]{1000000000}, //hp
            new int[]{209}, //map join
            new int[][]{
     ...
     public static final BossData SUPER_XEN = new BossData(
            ...
            7000, //dame
            new int[]{2000000000}, //hp
            new int[]{103, 101, 38, 145}, //map join
            new int[][]{
                {Skill.LIEN_HOAN, 1, 300},{Skill.LIEN_HOAN, 2, 400},{Skill.LIEN_HOAN, 3, 500},{Skill.LIEN_HOAN, 4, 600},{Skill.LIEN_HOAN, 5, 700},{Skill.LIEN_HOAN, 6, 800},{Skill.LIEN_HOAN, 7, 900},
                {Skill.KAMEJOKO, 7, 600}, {Skill.KAMEJOKO, 6, 700}, {Skill.KAMEJOKO, 5, 800}, {Skill.KAMEJOKO, 4, 900}, {Skill.KAMEJOKO, 3, 1000}, {Skill.KAMEJOKO, 2, 1100},{Skill.KAMEJOKO, 1, 1002},
              {Skill.ANTOMIC, 1, 130},  {Skill.ANTOMIC, 2, 140},  {Skill.ANTOMIC, 3, 150},{Skill.ANTOMIC, 4, 160},  {Skill.ANTOMIC, 5, 170},{Skill.ANTOMIC, 6, 190},  {Skill.ANTOMIC, 7, 200},
    ...
    public static final BossData KAMILOC = new BossData(
            ...
            new int[][]{
                    ...
                    {Skill.DICH_CHUYEN_TUC_THOI, 7, 1000000},
                    {Skill.DE_TRUNG, 7, 1000},
                    {Skill.THAI_DUONG_HA_SAN, 7, 12000000},
    ...
    public static final BossData CUMBERBLACK = new BossData(
            ...
            {Skill.ANTOMIC, 1, 130},  {Skill.ANTOMIC, 2, 140},  {Skill.ANTOMIC, 3, 150},{Skill.ANTOMIC, 4, 160},  {Skill.ANTOMIC, 5, 170},{Skill.ANTOMIC, 6, 190},  {Skill.ANTOMIC, 7, 200},
            {Skill.MASENKO, 1, 210}, {Skill.MASENKO, 5, 220}, {Skill.MASENKO, 6, 230},
            {Skill.DE_TRUNG, 7, 1000},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{}, //text chat 2
            new String[]{}, //text chat 3
            REST_15_M,
     ...
     public static final BossData CUMBERYELLOW = new BossData(
       ...
       public static final BossData SOI_HEC_QUYN = new BossData(
            ...
            ConstPlayer.TRAI_DAT, //gender
            Util.nextInt(1_000,100_000), //dame
            new int[]{Util.nextInt(40_000,999_999)}, //hp
    ...
    public static final BossData O_DO = new BossData(
            ...
            ConstPlayer.TRAI_DAT, //gender
            Util.nextInt(1_000,100_000), //dame
            new int[]{Util.nextInt(40_000,100_999)}, //hp
...
//                    {Skill.THAI_DUONG_HA_SAN, 1, 15000}
    ...
    public static final BossData SON_TINH = new BossData(
            ...
            1000, //dame
            new int[]{2000}, //hp
            new int[]{0, 1, 2, 7, 8, 9, 14, 15, 16,}, //map join
            new int[][]{
    ...
    public static final BossData CON_CU = new BossData(
            "Con Cu", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{282, 283, 284, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            550, //dame
            new int[]{2000000000}, //hp
    ...
    public static final BossData CON_CAC = new BossData(
            "Con Cặc", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{282, 283, 284, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            550, //dame
    ...
    public static final BossData NINJA_AO_TIM = new BossData(
            ...
            500000, //dame
            new int[]{Util.nextInt(100_000_000,500_000_000)}, //hp
            new int[]{54}, //map join
            new int[][]{ //skill
                    {Skill.DRAGON, 1, 100},
                   {Skill.KAMEJOKO, 1, 1000}, {Skill.KAMEJOKO, 2, 1200}, {Skill.KAMEJOKO, 5, 1500}, {Skill.KAMEJOKO, 7, 1700},
...
//           new int[]{86}, //map join
    ...
    public static final BossData TIEU_DOI_TRUONG_NM = new BossData(
            ...
            REST_15_M, //second rest
            new int[]{BossID.SO_4_NM, BossID.SO_3_NM, BossID.SO_2_NM, BossID.SO_1_NM} //boss join map together
    );

     public static final BossData DRAKULA = new BossData(
            "Drakula", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static final BossData VO_HINH = new BossData(
            "Vô Hình", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static final BossData SA_TANG = new BossData(
            "Sa Tăng", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static final BossData X3 = new BossData(
            "Quy Lão Kame", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static final BossData X4 = new BossData(
            "Jacky Chun", //name
            ConstPlayer.NAMEC, //gender
            new short[]{356, 357, 358, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            90, //dame
