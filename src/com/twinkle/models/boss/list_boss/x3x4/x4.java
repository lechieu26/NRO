...
// lag vcl
 public class x4 extends Boss {

    public x4() throws Exception {
        super(BossID.X4, BossesData.X4);
    }
    public void reward(Player plKill) {
        if (Util.isTrue(100, 100)) {
            Service.gI().dropItemMap(this.zone, Util.item711(zone, 711, 1, this.location.x, this.location.y, plKill.id));
        }
    }
    @Override
    public void active() {
