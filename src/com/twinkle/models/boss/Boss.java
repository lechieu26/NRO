...
import com.twinkle.models.boss.iboss.IBossNew;
import com.twinkle.models.boss.iboss.IBossOutfit;
import com.twinkle.models.boss.list_boss.NRD.*;
...
//        System.out.println("this status: " + this.bossStatus + " (" + this.id + ")");
    ...
    public void die(Player plKill) {
        if (plKill != null) {
            reward(plKill);
            ServerNotify.gI().notify(plKill.name + " vừa tiêu diệt được " + this.name + ", vip vãi loz");
        }
