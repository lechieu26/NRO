...
import com.twinkle.models.map.challenge.MartialCongressManager;
...
import com.twinkle.server.io.MyKeyHandler;
...
public class ServerManager {
    ...
    public static String NAME = "CHIEU";
    ...
    public void run() {
        ...
        activeGame();
        activeServerSocket();
        Logger.log(Logger.PURPLE_BOLD_BRIGHT,"Chạy Thành Công Rồi Đó Ahihi");
//        MaQuaTangManager.gI().init();
        ...
        try {
            ...
            Manager.MAPS.forEach(com.twinkle.models.map.Map::initBoss);
        ...
        new Thread(() -> {
            ...
            while (true) {
                ...
                if (line.equals("baotri")) {
                    ...
                    ServerNotify.gI().notify("NRO Twinkle debug server: " + Thread.activeCount());
