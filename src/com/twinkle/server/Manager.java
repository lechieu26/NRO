...
import com.twinkle.models.player.Referee;
import com.twinkle.models.player.Referee1;
import com.twinkle.models.reward.ItemMobReward;
import com.twinkle.models.reward.ItemOptionMobReward;
import com.twinkle.models.reward.MobReward;
import com.twinkle.models.shop.Shop;
import com.twinkle.models.skill.NClass;
import com.twinkle.models.skill.Skill;
import com.twinkle.models.task.SideTaskTemplate;
import com.twinkle.models.task.SubTaskMain;
...
//    public static byte RATE_EXP_SERVER = 1;// sau khi chinh
    ...
    public static final List<com.twinkle.models.map.Map> MAPS = new ArrayList<>();
    ...
    public static long timeRealTop = 0;                                                               //          áo       quần      găng       giày     áo       quần      găng       giày       áo       quần      găng       giày    9    10   11   12
    public static final short[] itemIds_TL = {935 ,555, 557, 559, 556, 558, 560, 562, 564, 566, 563, 565, 567, 561, 232, 233, 236, 237, 240, 241, 244, 245, 248, 249, 252, 253, 256, 257, 260, 261, 264, 265, 268, 269, 272, 273, 276, 277, 278, 279, 280, 281};
    public static final byte[] itemIds_NR_SB = {15,16,17,18,};
...
//        ArchivementManager.getInstance().init();
    ...
    private void initMap() {
        ...
        for (MapTemplate mapTemp : MAP_TEMPLATES) {
            ...
            com.twinkle.models.map.Map map = new com.twinkle.models.map.Map(mapTemp.id,
