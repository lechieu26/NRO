...
import com.nrotwinkle.card.RadarCard;
import com.nrotwinkle.card.RadarService;
            ...
            switch (item.template.type) {
                ...
                default:
                    switch (item.template.id) {
                        ...
                        case 2095:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 2072, 2073, 2074);
                            Service.gI().point(pl);
                            break;
                        case 1039:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 1258, 1259, 1260);
                            Service.gI().point(pl);
                            break;
                        case 2090:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        ...
                        case 2088:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 465, 466, 467);
                            Service.getInstance().point(pl);
                            break;
                        case 1046:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        ...
                        case 2046:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 2033, 2034, 2035);
                            Service.getInstance().point(pl);
                            break;
                        case 942:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        ...
                        case 1211: // Voi 9 ngà
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 1222, 1223, 1224);
                            Service.gI().point(pl);
                            break;
                        case 1212: // Gà 9 cựa
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 1225, 1226, 1227);
                            Service.gI().point(pl);
                            break;
                        case 1213: // Ngựa 9 hồng mao
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 1228, 1229, 1230);
                            Service.gI().point(pl);
                            break;
                        // Học supper kame
                        case 1175:
                            SkillService.gI().learSkillSpecial(pl, Skill.SUPER_KAME);
                            Service.gI().sendThongBao(pl, "Học thành công Super Kame lv1!");
                            break;
                        case 1179:
                            SkillService.gI().learSkillSpecial1(pl, Skill.SUPER_KAME);
                            Service.gI().sendThongBao(pl, "Học thành công Super Kame lv2!");
                            break;
                        case 1182:
                            SkillService.gI().learSkillSpecial2(pl, Skill.SUPER_KAME);
                            Service.gI().sendThongBao(pl, "Học thành công Super Kame lv3!");
                            break;
                        case 1185:
                            SkillService.gI().learSkillSpecial3(pl, Skill.SUPER_KAME);
                            Service.gI().sendThongBao(pl, "Học thành công Super Kame lv4!");
                            break;
                        case 1188:
                            SkillService.gI().learSkillSpecial4(pl, Skill.SUPER_KAME);
                            Service.gI().sendThongBao(pl, "Học thành công Super Kame lv5!");
                            break;
                        case 1191:
                            SkillService.gI().learSkillSpecial5(pl, Skill.SUPER_KAME);
                            Service.gI().sendThongBao(pl, "Học thành công Super Kame lv6!");
                            break;
                        case 1194:
                            SkillService.gI().learSkillSpecial6(pl, Skill.SUPER_KAME);
                            Service.gI().sendThongBao(pl, "Học thành công Super Kame lv7!");
                            break;
                        case 1197:
                            SkillService.gI().learSkillSpecial7(pl, Skill.SUPER_KAME);
                            Service.gI().sendThongBao(pl, "Học thành công Super Kame lv8");
                            break;
                        case 1200:
                            SkillService.gI().learSkillSpecial8(pl, Skill.SUPER_KAME);
                            Service.gI().sendThongBao(pl, "Học thành công Super Kame lv9!");
                            break;

                        // Học ma phong ba
                        case 1176:
                            SkillService.gI().learSkillSpecial(pl, Skill.MA_PHONG_BA);
                            Service.gI().sendThongBao(pl, "Học thành công Ma phong ba lv1!");
                            break;
                        case 1180:
                            SkillService.gI().learSkillSpecial1(pl, Skill.MA_PHONG_BA);
                            Service.gI().sendThongBao(pl, "Học thành công Ma phong ba lv2!");
                            break;
                        case 1183:
                            SkillService.gI().learSkillSpecial2(pl, Skill.MA_PHONG_BA);
                            Service.gI().sendThongBao(pl, "Học thành công Ma phong ba lv3!");
                            break;
                        case 1186:
                            SkillService.gI().learSkillSpecial3(pl, Skill.MA_PHONG_BA);
                            Service.gI().sendThongBao(pl, "Học thành công Ma phong ba lv4!");
                            break;
                        case 1189:
                            SkillService.gI().learSkillSpecial4(pl, Skill.MA_PHONG_BA);
                            Service.gI().sendThongBao(pl, "Học thành công Ma phong ba lv5!");
                            break;
                        case 1192:
                            SkillService.gI().learSkillSpecial5(pl, Skill.MA_PHONG_BA);
                            Service.gI().sendThongBao(pl, "Học thành công Ma phong ba lv6!");
                            break;
                        case 1195:
                            SkillService.gI().learSkillSpecial6(pl, Skill.MA_PHONG_BA);
                            Service.gI().sendThongBao(pl, "Học thành công Ma phong ba lv7!");
                            break;
                        case 1198:
                            SkillService.gI().learSkillSpecial7(pl, Skill.MA_PHONG_BA);
                            Service.gI().sendThongBao(pl, "Học thành công Ma phong ba lv8");
                            break;
                        case 1201:
                            SkillService.gI().learSkillSpecial8(pl, Skill.MA_PHONG_BA);
                            Service.gI().sendThongBao(pl, "Học thành công Ma phong ba lv9!");
                            break;

                        // HỌc liên hoàn chưởng
                        case 1177:
                            SkillService.gI().learSkillSpecial(pl, Skill.LIEN_HOAN_CHUONG);
                            Service.gI().sendThongBao(pl, "Học thành công Liên hoàn chưởng lv1!");
                            break;
                        case 1181:
                            SkillService.gI().learSkillSpecial1(pl, Skill.LIEN_HOAN_CHUONG);
                            Service.gI().sendThongBao(pl, "Học thành công Liên hoàn chưởng lv2!");
                            break;
                        case 1184:
                            SkillService.gI().learSkillSpecial2(pl, Skill.LIEN_HOAN_CHUONG);
                            Service.gI().sendThongBao(pl, "Học thành công Liên hoàn chưởng lv3!");
                            break;
                        case 1187:
                            SkillService.gI().learSkillSpecial3(pl, Skill.LIEN_HOAN_CHUONG);
                            Service.gI().sendThongBao(pl, "Học thành công Liên hoàn chưởng lv4!");
                            break;
                        case 1190:
                            SkillService.gI().learSkillSpecial4(pl, Skill.LIEN_HOAN_CHUONG);
                            Service.gI().sendThongBao(pl, "Học thành công Liên hoàn chưởng lv5!");
                            break;
                        case 1193:
                            SkillService.gI().learSkillSpecial5(pl, Skill.LIEN_HOAN_CHUONG);
                            Service.gI().sendThongBao(pl, "Học thành công Liên hoàn chưởng lv6!");
                            break;
                        case 1196:
                            SkillService.gI().learSkillSpecial6(pl, Skill.LIEN_HOAN_CHUONG);
                            Service.gI().sendThongBao(pl, "Học thành công Liên hoàn chưởng lv7!");
                            break;
                        case 1199:
                            SkillService.gI().learSkillSpecial7(pl, Skill.LIEN_HOAN_CHUONG);
                            Service.gI().sendThongBao(pl, "Học thành công Liên hoàn chưởng lv8");
                            break;
                        case 1202:
                            SkillService.gI().learSkillSpecial8(pl, Skill.LIEN_HOAN_CHUONG);
                            Service.gI().sendThongBao(pl, "Học thành công Liên hoàn chưởng lv9!");
                            break;
                        ...
                        case 2074: // bông tai c3
                            pl.fusion.isBTC3 = item.template.id == 2074;
                            UseItem.gI().usePorata3(pl);
                            break;
                        case 2075: // bông tai c4
                            pl.fusion.isBTC4 = item.template.id == 2075;
