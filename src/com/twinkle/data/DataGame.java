package com.twinkle.data;

import com.twinkle.models.Template.HeadAvatar;
import com.twinkle.models.Template.MapTemplate;
...
import com.twinkle.models.Template.MobTemplate;
import com.twinkle.models.Template.NpcTemplate;
import com.twinkle.models.Template.SkillTemplate;
...
public class DataGame {
    ...
    public static String LINK_IP_PORT = "CHIEU:192.168.110.128:14445:0,0,0";
        ...
        try {
            ...
            for (NClass nClass : Manager.NCLASS) {
                ...
                for (SkillTemplate skillTemp : nClass.skillTemplatess) {
                    ...
                    msg.writer().writeUTF("NRO Twinkle");
                    if (skillTemp.id != 0) {
...
public static void effData(MySession session, int id, int... idtemp) {
    ...
    try {
        ...
        byte[] effImg;
        if (idT == 1) {
            effData = FileIO.readFile("data/girlkun/effect/x" + session.zoomLevel + "/data/" + idT + "");
            effImg = FileIO.readFile("data/girlkun/effect/x" + session.zoomLevel + "/img/" + idT + ".png");
        } else {
            effData = FileIO.readFile("data/girlkun/effect/x" + session.zoomLevel + "/data/DataEffect_" + idT);
            effImg = FileIO.readFile("data/girlkun/effect/x" + session.zoomLevel + "/img/ImgEffect_" + idT + ".png");
        }
        msg = new Message(-66);
