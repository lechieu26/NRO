...
public class ShopKyGuiService {
    ...
    public List<ItemKyGui> getItemCanKiGui(Player pl) {
        ...
        pl.inventory.itemsBag.stream().filter((it) -> (it.isNotNullItem() && ((it.template.type < 5 && it.template.type >= 0) || it.template.type == 12 || it.template.type == 33 || it.template.type == 29 || it.template.type == 27 || it.template.type == 11 || it.template.type == 5))).forEachOrdered((it) -> {
