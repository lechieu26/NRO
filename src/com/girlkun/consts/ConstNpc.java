...
public class ConstNpc {
    ...
    public static final byte KAMIN = 79;
    public static final byte HUNGVUONG = 81;
    public static final byte ONGIA = 98;
    public static final byte DE_TU = 80;
    public static final byte MAY_GAP_THU = 88;
    public static final byte RUONG_PHU = 89;
    public static final byte BU_CU = 105;
     public static final byte BU_CU1 = 106;
    public static final byte TAI_XIU = 93;
    public static final byte GOKU_GOD = 104;
   public static final byte THO_REN = 83;
   public static final byte THUAN = 107;
   public static final byte DOI_QUA = 99;
   public static final byte HAO = 108;
    ...
    public static final int HANG_SOI = 535;
    ...
    public static final int MENU_CHUYEN_HOA_DO_HUY_DIET = 509;
    public static final int MENU_RANDOM_SKH = 510;
